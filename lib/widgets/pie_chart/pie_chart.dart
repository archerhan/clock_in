      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge(
              Assets.images.food.foodBaguette.path,
              size: widgetSize,
        ...
        case 1:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge(
              Assets.images.food.foodBroccoli.path,
              size: widgetSize,
              borderColor: AppColors.brightBlue,
            ),
            badgePositionPercentageOffset: .98,
        ...
        case 2:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge(
              Assets.images.food.foodCrab.path,
              size: widgetSize,
              borderColor: AppColors.grey999,
            ),
            badgePositionPercentageOffset: .98,
          );
        case 3:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge(
              Assets.images.food.foodCola.path,
              size: widgetSize,
